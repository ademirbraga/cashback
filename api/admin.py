...
class CashBackRevendedorAdmin(admin.ModelAdmin):
    list_display    = ['revendedor', 'pedido', 'valor', 'data']
    list_filter     = ('revendedor', 'pedido', 'valor', 'data')
    search_fields   = ('revendedor', 'pedido', 'valor', 'data')
    ordering        = ['revendedor', 'pedido', 'valor', 'data']
    save_as = True
